...
from Recomendacion.views import index,registro,RegistrarUsuario,login,Loguearse,deslog,userPanel,AdminPanel,SistemaRecomendacion,MostrarUSuarios,GestionTelevisores,ListarTelevisores,EstadisticasTelevisores,BuscarTelevisor,MostrarTelevisores,ModalTelevisores,MostarCalificaciones,MostrarRecomendaciones,MostrarPresicion,GuardarCalificacion,VerRecomendaciones,VerPerfilUsuario,CalificarRecomendacion
...
urlpatterns = [    
    ...
    path('calrecomendacion/',CalificarRecomendacion,name='CalificarRecomendacion'),
    ...
    path('userPanel/VerPerfilUsuario',VerPerfilUsuario,name='VerPerfilUsuario'),
